...
define('POST_STYLEPAKS_UPLOAD_DIR', UPLOADS_BASE_DIR.'wpbooklist/stylepaks/post/');

// Define the Posts Stylepaks base url
define('POST_STYLEPAKS_UPLOAD_URL', UPLOADS_BASE_URL.'wpbooklist/stylepaks/post/');

// Define the Pages Stylepaks base directory
define('PAGE_STYLEPAKS_UPLOAD_DIR', UPLOADS_BASE_DIR.'wpbooklist/stylepaks/page/');

// Define the Pages Stylepaks base url
define('PAGE_STYLEPAKS_UPLOAD_URL', UPLOADS_BASE_URL.'wpbooklist/stylepaks/page/');

// Define the page templates base directory
define('PAGE_TEMPLATES_UPLOAD_DIR', UPLOADS_BASE_DIR.'wpbooklist/templates/');
...
// Define the page templates base directory
define('PAGE_TEMPLATES_DEFAULT_DIR', ROOT_DIR.'includes/templates/');
...
// Upgrade function
//add_action( 'init', 'wpbooklist_upgrade_function');
...
add_action( 'admin_footer', 'wpbooklist_upload_new_post_stylepak_action_javascript' );
add_action( 'wp_ajax_wpbooklist_upload_new_post_stylepak_action', 'wpbooklist_upload_new_post_stylepak_action_callback' );
add_action( 'wp_ajax_nopriv_wpbooklist_upload_new_post_stylepak_action', 'wpbooklist_upload_new_post_stylepak_action_callback' );

// For uploading a new page StylePak after purchase
add_action( 'admin_footer', 'wpbooklist_upload_new_page_stylepak_action_javascript' );
add_action( 'wp_ajax_wpbooklist_upload_new_page_stylepak_action', 'wpbooklist_upload_new_page_stylepak_action_callback' );
add_action( 'wp_ajax_nopriv_wpbooklist_upload_new_page_stylepak_action', 'wpbooklist_upload_new_page_stylepak_action_callback' );
