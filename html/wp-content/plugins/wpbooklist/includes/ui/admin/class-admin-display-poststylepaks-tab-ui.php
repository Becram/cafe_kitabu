<?php
/**
 * WPBookList PostStylePaks Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_PostStylePaks_Display_Options_Tab', false ) ) :
/**
 * WPBookList_Admin_Menu Class.
 */
class WPBookList_PostStylePaks_Display_Options_Tab {

    public function __construct() {
    	require_once(CLASS_DIR.'class-admin-ui-template.php');
    	require_once(CLASS_DIR.'class-poststylepaks-display-options-form.php');
    	// Instantiate the class
		$this->template = new WPBookList_Admin_UI_Template;
		$this->form = new WPBookList_PostStylePaks_Display_Options_Form ;
...
// Instantiate the class
$am = new WPBookList_PostStylePaks_Display_Options_Tab;