<?php
/**
 * WPBookList Pages Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_Pages_Display_Options_Tab', false ) ) :
/**
 * WPBookList_Admin_Menu Class.
 */
class WPBookList_Pages_Display_Options_Tab {

    public function __construct() {
    	require_once(CLASS_DIR.'class-admin-ui-template.php');
    	require_once(CLASS_DIR.'class-pages-display-options-form.php');
    	// Instantiate the class
		$this->template = new WPBookList_Admin_UI_Template;
		$this->form = new WPBookList_Pages_Display_Options_Form;
    ...
    private function output_open_admin_container(){
        ...
        $icon_url = ROOT_IMG_ICONS_URL.'note.svg';
...
// Instantiate the class
$am = new WPBookList_Pages_Display_Options_Tab;