<?php
/**
 * WPBookList Posts Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_Posts_Display_Options_Tab', false ) ) :
/**
 * WPBookList_Admin_Menu Class.
 */
class WPBookList_Posts_Display_Options_Tab {
    ...
    private function output_open_admin_container(){
        ...
        $icon_url = ROOT_IMG_ICONS_URL.'blog.svg';
...
// Instantiate the class
$am = new WPBookList_Posts_Display_Options_Tab;