...
class WPBookList_Admin_Menu {
    ...
    private function setup_books_ui() {
        $this->tabs = array(
            'book'   => __("Add A Book", 'plugin-textdomain'),
            'edit-books'  => __("Edit & Delete Books", 'plugin-textdomain'),
        );
    ...
    private function setup_extensions_ui() {
        $this->tabs = array(
            'extensions'   => __("Extensions", 'plugin-textdomain'),
        );
    ...
    private function setup_display_options_ui() {
        $this->tabs = array(
            'library'   => __("Library", 'plugin-textdomain'),
            'posts'  => __("Posts", 'plugin-textdomain'),
            'pages'  => __("Pages", 'plugin-textdomain'),
            'librarystylepaks'  => __("Library StylePaks", 'plugin-textdomain'),
            'pagestylepaks'  => __("Page StylePaks", 'plugin-textdomain'),
            'poststylepaks'  => __("Post StylePaks", 'plugin-textdomain'),
        );
    ...
    private function setup_settings_ui() {
        $this->tabs = array(
            'libraries'   => __("Custom Libraries & Shortcodes", 'plugin-textdomain'),
            'api'  => __("API Settings", 'plugin-textdomain'),
            'backup'  => __("Backups", 'plugin-textdomain'),
            'amazonlocalization'  => __("Amazon Localization", 'plugin-textdomain'),
        );
