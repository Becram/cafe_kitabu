...
class WPBookList_Show_Book_In_Colorbox {
	...
	public function __construct($book_id, $book_table) {
		global $wpdb;
		// Construct the settings table name
		if(strpos($book_table, 'wpbooklist_jre_saved_book_log') !== false){
	...
	private function gather_user_options(){
		...
		$this->amazonaff = $options_results->amazonaff;
	...
	private function gather_color_options(){
		global $wpdb;
		$color_table_name = $wpdb->prefix . 'wpbooklist_jre_color_options';
  		$colors_row = $wpdb->get_row($wpdb->prepare("SELECT * FROM $color_table_name WHERE ID = %d", 1));

  		$this->addbookcolor = $color_row->addbookcolor;
		...
		$this->purchasebookcolor = $color_row->purchasebookcolor;
		$this->titlebookcolor = $color_row->titlebookcolor;
		$this->quotebookcolor = $color_row->quotebookcolor;
	...
	private function modify_author_url(){
		if($this->author_url != null){
	        if(!strpos($this->author_url, 'http://')){
			                ...
			                <tr>
			                    <td id="wpbooklist_image_saved_border">
			                       ...
			                       if($this->hidebookimage == null || $this->hidebookimage == 0){
									...
									if(($this->hiderating == null || $this->hiderating == 0) && ($this->rating != 0)){ 
						            ...
						            $string14 = '<div id="wpbooklist_display_table">
						                            ...
						                            if($this->hideauthor != 1){
						                            	$string18 = '<tr>
						                                    <td>
						                                        <span id="wpbooklist_bold">Author:</span> '.$this->author.'
						                                    </td>   
						                                </tr>
						                                ';
						                            }
													...
													if(($this->enablepurchase != null && $this->enablepurchase != 0) && $this->price != null && $this->hidecolorboxbuyprice != 1){
														// TODO: Add filter:  $string19 = '<tr><td><span id="wpbooklist_bold">Price:</span> '.$this->price.'</td>   </tr>';
						                            ...
						                            if($this->hidecategory != 1){
														...
														if($this->category == null){
							                            	$string21 = '<span id="wpbooklist_bold">Category: </span>Not Avaliable';
							                            } else {
							                            	$string21 = '<span id="wpbooklist_bold">Category: </span>'.$this->category;
							                            }
						                            ...
						                            if($this->hidepages != 1){
							                            ...
							                            if($this->pages == null){
							                            	$string24 = '<span id="wpbooklist_bold">Pages: </span>Not Avaliable';
							                            } else {
							                            	$string24 = '<span id="wpbooklist_bold">Pages: </span>'.$this->pages;
							                            }
						                            ...
						                            if($this->hidepublisher != 1){
							                            ...
							                            if($this->publisher == null){
							                            	$string27 = '<span id="wpbooklist_bold">Publisher: </span>Not Avaliable';
							                            } else {
							                            	$string27 = '<span id="wpbooklist_bold">Publisher: </span>'.$this->publisher;
							                            }
							                        ...
							                        if($this->hidepubdate != 1){
							                            ...
							                            if($this->pub_year == null){
							                            	$string30 = '<span id="wpbooklist_bold">Publication: </span>Not Avaliable';
							                            } else {
							                            	$string30 = '<span id="wpbooklist_bold">Publication: </span>'.$this->pub_year;
							                            }
							                        ...
							                        if($this->hidefinished != 1){
						                            	...
						                            	if($this->finished == 'true'){
								                            if($this->date_finished == 0){
								                            	$string33 = '<span id="wpbooklist_bold">Finished? </span>Yes';
								                            } else {
								                            	$string33 = '<span id="wpbooklist_bold">Finished? </span>Yes, on '.$this->date_finished;
								                            }
							                        	} else {
							                        		$string34 = '<span id="wpbooklist_bold">Finished? </span>Not Yet';
							                        	}
													...
													if($this->hidesigned != 1){			
						                            	...
						                            	if($this->signed == 'true'){
								                            $string37 = '<span id="wpbooklist_bold">Signed? </span>Yes';
							                        	} else {
							                        		$string37 = '<span id="wpbooklist_bold">Signed? </span>No';
							                        	}
							                        	$string38 = '</td>
							                                </tr>';
							                        }
							                        ...
							                        if($this->hidefirstedition != 1){
						                            	...
						                            	if($this->first_edition == 'true'){
								                            $string40 = '<span id="wpbooklist_bold">First Edition? </span>Yes';
							                        	} else {
							                        		$string40 = '<span id="wpbooklist_bold">First Edition? </span>No';
							                        	}
							                        ...
							                        if($this->hidebookpage != 1 && $this->page_id != null && $this->page_id != 'false'){
							                        	$string42 = '<tr>
						                                    <td>
						                                    	<span id="wpbooklist_bold"><a id="wpbooklist-purchase-book-view" href="'.get_permalink( $this->page_id ).'">Book Page</a></span>
																</td>
                            							</tr>';
							                        }
							                        ...
							                        if($this->hidebookpost != 1 && $this->post_id != null && $this->post_id != 'false'){
							                        	$string43 = '<tr>
						                                    <td>
						                                    	<span id="wpbooklist_bold"><a id="wpbooklist-purchase-book-view" href="'.get_permalink( $this->post_id ).'">Book Post</a></span>
																</td>
                            							</tr>';
						                        	...
						                        	if(($this->hideamazonpurchase == null || $this->hideamazonpurchase == 0) || ($this->hidebnpurchase == null || $this->hidebnpurchase == 0) || ($this->hidegooglepurchase == null || $this->hidegooglepurchase == 0) || ($this->hideitunespurchase == null || $this->hideitunespurchase == 0) || ($this->hidecolorboxbuyimg == null || $this->hidecolorboxbuyimg == 0)){
														...
														$string51 = ' class="wpbooklist-purchase-img" href="http://www.barnesandnoble.com/s/'.$this->isbn.'" target="_blank">
														...
														$string55 = ' class="wpbooklist-purchase-img" href="'.$this->itunes_page.'" target="_blank">
																<img src="'.ROOT_IMG_URL.'ituneslink.png" id="wpbooklist-itunes-img" /></a><a ';
							                        	...
							                        	$string60 = '';
														if ($this->hidegoodreadswidget == null || $this->hidegoodreadswidget == 0){
                            								$string60 = '<td> 
														...
														if($this->hidedescription == null || $this->hidedescription == 0){
														     $string68 = '<p class="wpbooklist_description_p" id="wpbooklist-desc-title-id">Description:</p>'; 

														    if($this->description == null){
													        	$string69 = '<p class="wpbooklist_desc_p_class">Not Available</p>';
													        } else {
													        	$string69 = '<div class="wpbooklist_desc_p_class">'.$this->description.'</div>';
													        } 
														}

														$string70 = '';
														if(($this->hideamazonreview == null || $this->hideamazonreview == 0) && ($this->review_iframe != null)){
													            $string70 = '<p class="wpbooklist_description_p">Amazon Reviews:</p> 
													    ...
													    if($this->hidenotes == null || $this->hidenotes == 0){
													         $string71 = '<p class="wpbooklist_description_p">Notes:</p>';

												            if($this->notes == null){
												                $string72 = '<p class="wpbooklist_desc_p_class">None Provided</p>';
												            } else {
												                $string72 = '<p class="wpbooklist_desc_p_class">'.$this->notes.'</p>';
												            } 
													    }

													    $string73 = '';
													    if (($this->hideamazonpurchase == 1) && ($this->hidebnpurchase == 1) && ($this->hidegooglepurchase == 1) && ($this->hideitunespurchase == 1) && ($this->hidecolorboxbuyimg == 1)){
														...
														$string82 = ' class="wpbooklist-purchase-img" href="'.$this->itunes_page.'" target="_blank">
																<img id="wpbooklist-itunes-img" src="'.ROOT_IMG_URL.'ituneslink.png" /></a>';
