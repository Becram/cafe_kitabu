...
class WPBookList_Display_Options {
	...
	public function save_library_settings($table, $settings_array = array()){
        ...
        $format = array('%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%s', '%d'); 
        $where = array( 'ID' => 1 );
        $where_format = array('%d');
        $result = $wpdb->update( $final_table, $settings_array, $where, $format, $where_format );
	...
	public function save_post_settings($settings_array = array()){
        ...
        $format = array('%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%s'); 
        $where = array( 'ID' => 1 );
        $where_format = array('%d');
        $result = $wpdb->update( $table, $settings_array, $where, $format, $where_format );
